...
MANAGEMENT_OPERATION_PERMISSIONS = {
    ...
    "list_member_candidates": "members.manage",
    ...
    "update_role_binding": "role_bindings.manage",
    ...
    "get_application_authorization_representative": "applications.read",
    "bind_application_authorization_representative": "applications.manage",
    "revoke_application_authorization_representative": "applications.manage",
    ...
    "create_application_quota": "quotas.manage",
...
DATA_PLANE_OPERATION_PERMISSIONS = {
    ...
    "get_file": "files.read",
    "get_ingestion_provenance": "files.read",
    ...
    "complete_direct_upload": "files.write",
    "create_presigned_download": "presigned_urls.issue",
    "create_multipart_upload": "files.write",
    "get_multipart_upload": "files.write",
    "abort_multipart_upload": "files.write",
    "upload_multipart_part": "files.write",
    "list_multipart_parts": "files.write",
    "complete_multipart_upload": "files.write",
}
