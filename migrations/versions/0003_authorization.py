...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "tenant_id", "group_id", "principal_id", name="uq_group_member_membership"
        ),
    )
    ...
    op.create_index(
        "ix_role_binding_tenant_principal", "role_binding", ["tenant_id", "principal_id"]
    )
    op.create_index(
        "ix_role_binding_tenant_scope",
        "role_binding",
        ["tenant_id", "storage_space_id", "canonical_prefix"],
    )
